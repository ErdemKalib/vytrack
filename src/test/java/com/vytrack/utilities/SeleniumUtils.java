...
//            wait.until((Function<? super WebDriver, Object>) expectation);
...
//    }
    ...
    public static String getScreenshot(String name)  {
        ...
        String date = LocalDateTime.now().format(DateTimeFormatter.BASIC_ISO_DATE.ofPattern("yyyyMMdd_hh:mm:ss a"));
